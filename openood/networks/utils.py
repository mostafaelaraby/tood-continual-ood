...
def get_network(network_config):
    ...
    if (
        hasattr(network_config, "modification")
        and network_config.modification == "t2fnorm"
    ):
        ...
        net = T2FNormNet(
            backbone=backbone, tau=network_config.tau, num_classes=num_classes
        )
    ...
    if network_config.pretrained:
        if type(net) is dict:
            ...
            weights = eval(f"MobileNet_V2_Weights.IMAGENET1K_V1")
